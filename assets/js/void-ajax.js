jQuery( function( $ ) {
    elementor.hooks.addAction( 'panel/open_editor/widget/void-post-grid', function( panel, model, view ) {
        ...
        elementor.channels.editor.on('section:activated',function(){
               ...
               // $e.routes.clearHistory( elementor.component.getServiceName() );
                
                //$e.routes.refreshContainer( 'panel/elements/categories' );
                // if($e.routes.getHistory( 'panel/elements/categories' )){

                // }
              
                if(elementor.getPanelView().currentPageView.activeSection == 'section_content'){

                        //$el.remove();
                 //   container.panel.refresh();
                //console.log(elementor.getPanelView().currentPageView.activeSection);
                void_grid_data_pass_around_model( panel,model,view );
               
               // console.log($e.hooks.data);
